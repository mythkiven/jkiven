...
- (void)creatgroup0 {
    ...
    YJArrowItem *item0 = [YJArrowItem itemWithIcon:@"me_icon_purchaseHistory" Title:@"标准消费" destVc:[YJPurchaseHistoryVC class]];
    ...
    // 公司认证新增: 
    YJArrowItem *item3 = [YJArrowItem itemWithIcon:@"me_icon_zizhirenzhen" Title:@"资质认证" destVc:nil];
    ...
    group.groups = @[item0,item1,item2,item3];
...
- (void)creatgroup1 {
    ...
    YJArrowItem *item1 = [YJArrowItem itemWithIcon:@"me_icon_setting" Title:@"账号设置" destVc:[AccountSetting class]];
    
    YJArrowItem *item3 = [YJArrowItem itemWithIcon:@"me_icon_ideas" Title:@"意见反馈" destVc:[YJIdeaVC class]];
    
    YJItemGroup *group = [[YJItemGroup alloc] init];
    
    group.groups = @[item1,item3];
