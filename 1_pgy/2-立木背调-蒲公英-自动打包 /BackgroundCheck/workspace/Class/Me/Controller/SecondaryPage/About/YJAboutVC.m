...
- (void)setupHeaderView  {
    ...
    bgView.frame =CGRectMake(0, 0, SCREEN_WIDTH, 210);
    
    CGFloat imgW = 152/2.0;
    CGFloat imgH = 160/2.0;
    UIImageView *iconView = [[UIImageView alloc] init];
    iconView.backgroundColor = RGB_pageBackground;
    iconView.frame = CGRectMake((SCREEN_WIDTH-imgW)*0.5, 49, imgW, imgH);
    //    iconView.center = bgView.center;
    iconView.image = [UIImage imageNamed:@"me_about_logo"];
...
//    };
    ...
    YJBaseItem *item2 = [YJBaseItem itemWithTitle:@"电子邮箱" subTitle:@"limu@limuzhengxin.com"];
