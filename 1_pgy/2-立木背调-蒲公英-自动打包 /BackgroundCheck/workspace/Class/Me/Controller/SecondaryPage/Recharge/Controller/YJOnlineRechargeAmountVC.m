...
- (void)viewDidLoad {
    ...
    [_sureBtn setBackgroundImage:[UIImage imageWithColor:[UIColor  colorWithHexString:@"#39b31b"]] forState:(UIControlStateNormal)];
    [_sureBtn setBackgroundImage:[UIImage imageWithColor:[UIColor  colorWithHexString:@"#39b31b"]] forState:(UIControlStateHighlighted)];
