...
+ (void)showLoginView {
    ...
    JENavigationController *nav = [[JENavigationController alloc]initWithRootViewController:login];
    [[self getPresentedViewController] presentViewController:nav animated:YES completion:NULL];
