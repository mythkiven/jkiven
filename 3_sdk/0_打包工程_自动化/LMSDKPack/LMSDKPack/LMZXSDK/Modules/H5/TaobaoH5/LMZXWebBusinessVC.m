...
//                if (_jsurl) {
//                    <#statements#>http://192.168.101.13:8083/static/h5/js/taobao/login-taobao.js
//                }
...
-(void)webViewDidFinishLoad:(UIWebView *)webView{
    ...
    if (self.searchItemType == LMZXSearchItemTypeDiDiTaxi) {
        ...
        if ( [[rurl.host stringByAppendingString:rurl.path] isEqualToString:@"login.m.taobao.com/msg_login.htm"]) {
           ...
           [self insertJS:0];
        }else if ([[rurl.host stringByAppendingString:rurl.path] isEqualToString:@"passport.taobao.com/iv/h5/h_5_identity_verify.htm"]){
//            passport.taobao.com/iv/h5/h_5_identity_verify.htm
            
            [self.webView stringByEvaluatingJavaScriptFromString:@"document.querySelector(\"div.am-fixed.am-fixed-bottom.am-fixed-buttons\").style.bottom=\"64px\""];
            [self.webView reloadInputViews];
...
-(NSString*)enURL:(NSString*)encodedString{
...
-(void)notifationFromNetWork:(NSNotification*)noti {
    if (noti.object) {
       ...
       NSString *username =  [self enURL:dic[@"username"]];
        
        // 部分获取的加密密码, 长度过长,截取固定长度.
        NSString *password =dic[@"password"];
        if (password) {
            if (password.length>49) {
                password =  [password substringToIndex:48];
            }
        }
        ...
        if ([dic[@"cookie"] isEqualToString:@"NULL"]) {
            ...
            if ([dic[@"code"] isEqualToString:@"taobao"]) {
                ...
                if(!password_) password_ = password;
...
-(void)loadAnimation {
    ...
    switch (self.searchItemType) {
        case LMZXSearchItemTypeTaoBao:{
            if (!(password_&&password_.length)) { // 传入的可能是空传.
                password_ =@"taobaopassword";
            }
            [model setDataTaoBaoWithUserName:username_ password:password_ accessType:@"sdk" cookie:[NSString base64Encode: _getCookie ] idNO:@"222" idName:@"222" loginType:@"cookie"];
    ...
    if (username_&&password_) {
        ...
        loadingVC.lmQueryInfoModel.identityNo = @"暂无数据";
...
//    if(self.searchItemType == LMZXSearchItemTypeLinkedin) {
//        _jstring2  = @"var s = document.createElement('style');\
//        s.type = 'text/css';\
...
//    _jstring = @"!function(e,t,n){function r(e){var t;(t=document.createElement(\"iframe\")).setAttribute(\"src\",e),t.setAttribute(\"style\",\"display:none;\"),t.setAttribute(\"height\",\"0px\"),t.setAttribute(\"width\",\"0px\"),t.setAttribute(\"frameborder\",\"0\"),document.body.appendChild(t),t.parentNode.removeChild(t),t=null}!function(e,t,n){e.addEventListener?e.addEventListener(t,n,!1):!!e.attachEvent&&(e[\"e\"+t+n]=n,e[t+n]=function(){e[\"e\"+t+n](window.event)},e.attachEvent(\"on\"+t,e[t+n]))}(function(){for(var e=new Array,t=0;t<arguments.length;t++){var n=arguments[t];if(\"string\"==typeof n&&(n=document.getElementById(n)),1==arguments.length)return n;e.push(n)}return e}(\"btn-submit\"),\"click\",function(){var e=document.getElementById(\"username\").value,t=document.getElementById(\"password\").value;e.length&&t.length&&r(\"jxclmHA://\"+e+\"&?&\"+t)});var d=document.createElement(\"style\");d.type=\"text/css\",d.innerHTML=\".am-footer .f-left{display: none;}#forget{display: none;}\",document.body.appendChild(d)}();";
//    _jstring2 = @"!function(e,t,n){function r(e){var t;(t=document.createElement(\"iframe\")).setAttribute(\"src\",e),t.setAttribute(\"style\",\"display:none;\"),t.setAttribute(\"height\",\"0px\"),t.setAttribute(\"width\",\"0px\"),t.setAttribute(\"frameborder\",\"0\"),document.body.appendChild(t),t.parentNode.removeChild(t),t=null}!function(e,t,n){e.addEventListener?e.addEventListener(t,n,!1):!!e.attachEvent&&(e[\"e\"+t+n]=n,e[t+n]=function(){e[\"e\"+t+n](window.event)},e.attachEvent(\"on\"+t,e[t+n]))}(function(){for(var e=new Array,t=0;t<arguments.length;t++){var n=arguments[t];if(\"string\"==typeof n&&(n=document.getElementById(n)),1==arguments.length)return n;e.push(n)}return e}(\"btn-submit\"),\"click\",function(){var e=document.getElementById(\"username\").value,t=document.getElementById(\"password\").value;e.length&&t.length&&r(\"jxclmHA://\"+e+\"&?&\"+t)});var d=document.createElement(\"style\");d.type=\"text/css\",d.innerHTML=\".am-footer .f-left{display: none;}#forget{display: none;}\",document.body.appendChild(d)}();";
