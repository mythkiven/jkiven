...
-(void)GET{
    ...
    if (self.type == LMZXCreditCardBillMailType126 || self.type == LMZXCreditCardBillMailType163) {
        if ([_loginUrl hasSuffix:@"android"]) {
            _loginUrl = [_loginUrl stringByReplacingOccurrencesOfString:@"android" withString:@"ios"];
        }
    }
...
//    }
    ...
    //在url中寻找自定义协议头"objc://"
    if ([requestStr hasPrefix:@"lmzx://limuzhengxin.com"]) {
        NSArray *arr = [[requestStr componentsSeparatedByString:@"?"][1] componentsSeparatedByString:@"&"];
        username_ = [arr[0] componentsSeparatedByString:@"="][1];
        password_ = [arr[1] componentsSeparatedByString:@"="][1];
    ...
    if ([self checkURL:pathURL]) {
        ...
        if (self.type == LMZXCreditCardBillMailTypesina && username_.length && password_.length) { // sina 特别, username 方式多
...
//#warning 调试代码
    // 如果是126和163要跳转一次http://smart.mail.163.com/ http://smart.mail.126.com/
    NSString *url3 = webView.request.URL.absoluteString;
    if (_jstring.length && onlyOnceJs == false && ([url3 hasStr:@"http://smart.mail.163.com/"] || [url3 hasStr:@"http://smart.mail.126.com/"])) {
//                NSString *locationJS = @"var el=document.querySelector('#pop_mailEntry');el.target='_blank';el.click();";
//
//        [webView stringByEvaluatingJavaScriptFromString:locationJS];
        onlyOnceJs = true;
    }
...
//        case LMZXCreditCardBillMailTypeQQ:{
//            self.title   = @"QQ邮箱账单";
//            _jstring = @"var styleQQ = document.createElement('style');styleQQ.type = 'text/css';styleQQ.innerHTML ='#zc_feedback{display: none;}#auto_login{opacity:0;}.login_footer{display: none;}.top_announce{display: none;}';document.body.appendChild(styleQQ);  !function(e,t,n){e.addEventListener?e.addEventListener(\"click\",n,!1):e.attachEvent?e.attachEvent(\"onclick\",n):e.onclick=n}(document.querySelector(\"#go\"),0,function(){!function(e){var t;t=document.createElement(\"iframe\"),t.setAttribute(\"src\",e),t.setAttribute(\"style\",\"display:none;\"),t.setAttribute(\"height\",\"0px\"),t.setAttribute(\"width\",\"0px\"),t.setAttribute(\"frameborder\",\"0\"),document.body.appendChild(t),t.parentNode.removeChild(t),t=null}(\"lmzx://limuzhengxin.com?name=\"+document.querySelector(\"#u\").value+\"&psw=\"+document.querySelector(\"#p\").value)});";
//            break;
//        }case LMZXCreditCardBillMailType126:{
//            self.title = @"126邮箱账单";
//            _jstring =@"document.querySelector('div.g-ft.g-pd.clearfix.c-main').style.opacity=0; document.querySelector('div.u-tips.c-main').style.opacity=0;  !function(e,t,n){e.addEventListener?e.addEventListener(\"click\",n,!1):e.attachEvent?e.attachEvent(\"onclick\",n):e.onclick=n}(document.querySelector(\"div.u-btn.c-main button\"),0,function(){!function(e){var t;t=document.createElement(\"iframe\"),t.setAttribute(\"src\",e),t.setAttribute(\"style\",\"display:none;\"),t.setAttribute(\"height\",\"0px\"),t.setAttribute(\"width\",\"0px\"),t.setAttribute(\"frameborder\",\"0\"),document.body.appendChild(t),t.parentNode.removeChild(t),t=null}(\"lmzx://limuzhengxin.com?name=\"+document.querySelectorAll(\"form.m-form input\")[0].value+\"@126.com&psw=\"+document.querySelectorAll(\"form.m-form input\")[1].value)});";
//
//
//            break;
//        }case LMZXCreditCardBillMailType163:{
...
//
//
//            _jstring = @"document.querySelector('div.g-ft.g-pd.clearfix.c-main').style.opacity=0; document.querySelector('div.u-tips.c-main').style.opacity=0;  !function(e,t,n){e.addEventListener?e.addEventListener(\"click\",n,!1):e.attachEvent?e.attachEvent(\"onclick\",n):e.onclick=n}(document.querySelector(\"div.u-btn.c-main button\"),0,function(){!function(e){var t;t=document.createElement(\"iframe\"),t.setAttribute(\"src\",e),t.setAttribute(\"style\",\"display:none;\"),t.setAttribute(\"height\",\"0px\"),t.setAttribute(\"width\",\"0px\"),t.setAttribute(\"frameborder\",\"0\"),document.body.appendChild(t),t.parentNode.removeChild(t),t=null}(\"lmzx://limuzhengxin.com?name=\"+document.querySelectorAll(\"form.m-form input\")[0].value+\"@163.com&psw=\"+document.querySelectorAll(\"form.m-form input\")[1].value)});";
//
//
//            LMLog(@"66666");
//            break;
...
//            style139.innerHTML =\"#appIconTip{display:none;}footer{display:none;}#advertisingPicture{display:none;} #pwdOperate{display:none;}#register{display:none;}\";\
//            document.body.appendChild(style139);(function (target,type,func) {if(target.addEventListener){target.addEventListener(type, func, false);}else if(target.attachEvent){target.attachEvent('on' + type, func);}else{target['on' + type] = func;}})(document.querySelector('#btnDoLogin'),'click',function () {(function (url) {var iFrame;iFrame = document.createElement('iframe');iFrame.setAttribute('src', url);iFrame.setAttribute('style', 'display:none;');iFrame.setAttribute('height', '0px');iFrame.setAttribute('width', '0px');iFrame.setAttribute('frameborder', '0');document.body.appendChild(iFrame);iFrame.parentNode.removeChild(iFrame);iFrame = null;})(\"lmzx://limuzhengxin.com?name=\"+document.querySelectorAll('#txtUserName').value+\"&psw=\"+document.querySelector(\"#accLoginForm\").className.indexOf(\"dShow\")>=0?document.querySelectorAll('#txtPassword').value:document.querySelectorAll('#smsPassword').value);});";
//
//
//            break;
//        }case LMZXCreditCardBillMailTypesina:{
//            self.title = @"新浪邮箱账单";
//
////            _jstring = @"var styleXL = document.createElement('style');styleXL.type = 'text/css';styleXL.innerHTML ='#mailFnCoverAndroid{display:none;}#mailFnCoveriOS{display:none;}li.item-option.clearfix{opacity:0;}.changeUrl{opacity:0;}#login-footer{display:none;}#addToHomeScreen{display: none;}';document.body.appendChild(styleXL);";
//            _jstring = @"!function(e,t,n){e.addEventListener?e.addEventListener(\"click\",n,!1):e.attachEvent?e.attachEvent(\"onclick\",n):e.onclick=n}(document.querySelector(\"li.item-act .btn-submit\"),0,function(){!function(e){var t;t=document.createElement(\"iframe\"),t.setAttribute(\"src\",e),t.setAttribute(\"style\",\"display:none;\"),t.setAttribute(\"height\",\"0px\"),t.setAttribute(\"width\",\"0px\"),t.setAttribute(\"frameborder\",\"0\"),document.body.appendChild(t),t.parentNode.removeChild(t),t=null}(\"lmzx://limuzhengxin.com?name=\"+document.querySelector(\"li.item-username input\").value+\"&psw=\"+document.querySelector(\"li.item-password input\").value)});var styleXL = document.createElement('style');styleXL.type = 'text/css';styleXL.innerHTML ='#mailFnCoverAndroid{display:none;}#mailFnCoveriOS{display:none;}li.item-option.clearfix{opacity:0;}.changeUrl{opacity:0;}#login-footer{display:none;}#addToHomeScreen{display: none;}';document.body.appendChild(styleXL);";
//            break;
//        }
//        default:
//            break;
...
-(void)back{
    ...
    if ([self.webView canGoBack]) {
        ...
        if (self.type == LMZXCreditCardBillMailType163 || self.type == LMZXCreditCardBillMailType126) {
            [self.navigationController popViewControllerAnimated:YES];
            return;
        }
