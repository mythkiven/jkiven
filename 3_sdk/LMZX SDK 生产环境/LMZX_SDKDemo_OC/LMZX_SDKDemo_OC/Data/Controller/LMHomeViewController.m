...
// SDK 是单例,因此设置一个功能的某项属性与全局不同时,需要设置其余功能相应的属性.
-(void)setCustomSDKWithFunction:(NSString*)function{
    // 用户切换后,需要重置 UID
    _lmzxSDK.lmzxUid = @"APP切换用户后新的UID";
...
//        // 协议 URL
//        _lmzxSDK.lmzxProtocolUrl = @"自主协议 URL";
    }else{
//        // 以下设置其余功能对应的默认属性
//        
//        // 回调地址
...
//        _lmzxSDK.lmzxThemeColor =  RGB(48, 113, 242);
//        // 协议 URL
//        _lmzxSDK.lmzxProtocolUrl = @"默认协议 URL";
    }
...
- (void)post:(NSString*)authInfo{
    ...
    dispatch_async(dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_DEFAULT, 0), ^{
        ...
        NSMutableURLRequest *request= [[NSMutableURLRequest alloc]initWithURL:[NSURL URLWithString:@"www.baidu.com"] cachePolicy:NSURLRequestReloadIgnoringCacheData timeoutInterval:30];
