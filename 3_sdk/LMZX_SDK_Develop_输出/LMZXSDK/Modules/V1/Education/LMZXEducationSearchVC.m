...
@interface LMZXEducationSearchVC ()<UITextFieldDelegate,UIGestureRecognizerDelegate>
{
...
@implementation LMZXEducationSearchVC
...
- (void)didClickedSearch{
    ...
    LMZXEducationLoadingVC *loadingVc = [[LMZXEducationLoadingVC alloc] init];
