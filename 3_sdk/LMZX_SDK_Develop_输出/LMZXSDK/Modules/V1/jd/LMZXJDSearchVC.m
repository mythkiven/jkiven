...
@interface LMZXJDSearchVC ()<UITextFieldDelegate,UIGestureRecognizerDelegate>
{
...
//    LMLog(@"first:%@-two:%@-three:%@",self.firstTextField,self.twoTextField,self.threeTextField);
    ...
    [self.lmQueryInfoModel setDataJDWithUserName:self.firstTextField password:self.twoTextField accessType:@"sdk" cookie:@"" idNO:@"idNo" idName:@"idName" loginType:@"normal"];
    
    
    LMZXJdLoadingVC *loadingVc = [[LMZXJdLoadingVC alloc] init];
