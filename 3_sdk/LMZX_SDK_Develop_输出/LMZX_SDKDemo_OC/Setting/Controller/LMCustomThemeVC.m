        ...
        default:
        {
            ...
            if (indexPath.section == 1) {
                switch (seg.selectedSegmentIndex) {
                    case 0:
                        sdk.lmzxStatusBarStyle = LMZXStatusBarStyleLightContent;
                        break;
                    case 1:
                        sdk.lmzxStatusBarStyle = LMZXStatusBarStyleDefault;
                        break;
                    default:
                        break;
                }
                ...
                switch (seg.selectedSegmentIndex) {
                    case 0:
                        sdk.lmzxQuitOnSuccess = YES;
                        
                        break;
                    case 1:
                        sdk.lmzxQuitOnSuccess = NO;
                        break;
                    default:
                        break;
                }
