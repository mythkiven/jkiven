...
//static YJAlipayOrder *_instance;
//
//+ (instancetype)shareAlipayOrder {
//    if (_instance == nil) {
//        _instance = [[YJAlipayOrder alloc] init];
//    }
//    return _instance;
//}
//
...
- (void)setBiz_content:(NSString *)biz_content {
    _biz_content = biz_content;
    
    
    
    _bizcontent = [YJBizContent mj_objectWithKeyValues:[biz_content mj_JSONObject]];
...
//@"biz_content":_bizcontent.description?:@"",
