...
@interface LMZXTaobaoSearchVC ()<UITextFieldDelegate,UIGestureRecognizerDelegate>
{
...
@implementation LMZXTaobaoSearchVC
...
- (void)didClickedSearch{
    ...
    [self.lmQueryInfoModel setDataTaoBaoWithUserName:self.firstTextField password:self.twoTextField accessType:@"sdk" cookie:@"cookie" idNO:@"id" idName:@"" loginType:@"cookie"];
