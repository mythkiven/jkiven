...
@interface LMZXLostCreditVC  ()<UITextFieldDelegate,UIGestureRecognizerDelegate>
{
...
@implementation LMZXLostCreditVC
...
- (void)didClickedSearch{
    ...
    self.lmQueryInfoModel.name = self.firstTextField;
    self.lmQueryInfoModel.identityNo = self.twoTextField;
