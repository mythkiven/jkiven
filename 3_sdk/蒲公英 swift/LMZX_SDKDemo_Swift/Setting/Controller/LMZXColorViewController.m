...
- (void)viewDidLoad {
    ...
    _colorView.layer.borderColor = [self colorWithHexString:@"#f1f1f1"].CGColor;
...
- (void)alphaView:(LMZXAlphaView *)alphaView changeAlpha:(CGFloat)alpha {
    ...
    if (_isHexColor) {
        _colorView.backgroundColor = [self colorWithHexString:[@"#" stringByAppendingString:_colorTf.text] alpha:alpha];
    } else {
...
- (BOOL)textFieldShouldReturn:(UITextField *)textField {
    ...
    _colorView.backgroundColor = [self colorWithHexString:[@"#" stringByAppendingString:textField.text]];
